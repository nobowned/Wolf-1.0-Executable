...
void SV_Init( void ) {
	...
	sv_master[0] = Cvar_Get( "sv_master1", "wolfmaster.s4ndmod.com", 0 );      // L0 - custom master server
	sv_master[1] = Cvar_Get( "sv_master2", "dpmaster.deathmask.net", CVAR_ARCHIVE );	// L0 - set this as default in case if s4ndmod lags out..
